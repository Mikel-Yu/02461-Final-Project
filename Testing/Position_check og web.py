    ...
    if frame_counter % 120 == 0: # Analyze every x'th frame
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                new_list.append([x1, y1, x2, y2,classNames[cls]])

        position_check(new_list,old_list) #opdager ikke hvis et piece er forsvundet hvis der ikke er sket andre ændringer
